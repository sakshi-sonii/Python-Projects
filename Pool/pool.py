...
#load images
cue_image = pygame.image.load("D:\Python Projects\Pool\image\cue.png").convert_alpha()
table_image = pygame.image.load("D:\Python Projects\Pool\image/table.png").convert_alpha()
ball_images = []
for i in range(1, 17):
  ball_image = pygame.image.load(f"D:\Python Projects\Pool\image/ball_{i}.png").convert_alpha()
